...
static PyObject* compute_coherent_summation(PyObject* self, PyObject* args) {
	...
	Array2D<double> rec_samples_data2D(rec_samples_data, n_rec, n_samples);
	...
	compute(rec_samples_data2D, rec_coords_data2D, sources_coords_data2D, sources_times_data2D, tensor_matrix_data, result_arr_data);

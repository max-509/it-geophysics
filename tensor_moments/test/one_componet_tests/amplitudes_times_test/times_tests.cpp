#ifdef ARGS
#include "amplitudes_args/src/coherent_summation.h"
#endif

#ifdef NO_ARGS
#include "amplitudes_no_args/src/coherent_summation.h"
#endif

#ifdef INPLACE
#include "amplitudes_calc_inplace/src/coherent_summation.h"
#endif
